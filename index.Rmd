...
# # m plots ####
  ...
  ggplot(data = df_m, aes(x = Yr_Mo, y = Unemployed_PctPop16)) +
    ...
    labs(subtitle="Percent of Labor Force") + # geom_line()
    geom_ribbon(aes(ymin=min(Unemployed_PctPop16, na.rm = T)-1, 
                    ymax=Unemployed_PctPop16), fill="darkorchid")
  ...
  ggplot(data = df_m, aes(x = Yr_Mo, y = Employed_PctPop16)) +
    ...
    geom_ribbon(aes(ymin=min(Employed_PctPop16, na.rm = T)-1,
                    ymax=Employed_PctPop16), fill="darkorchid")
  ...
  ggplot(data = df_m, aes(x = Yr_Mo, y = NotInLF_PctPop16)) +
    ...
    labs(title="Not in Labor Force",
         ...
         caption="Source: Employment Situation, U.S. Bureau of Labor Statistics") +
    labs(subtitle="Percent of Population Over 16") + 
    geom_ribbon(aes(ymin=min(NotInLF_PctPop16, na.rm=T)-1,
                    ymax=NotInLF_PctPop16), fill="darkorchid")
