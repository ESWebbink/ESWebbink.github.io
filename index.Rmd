...
df_m <- read_tsv("data/Facets_Monthly.txt")
# colnames(df_m)
...
```{r monthly_plots1, figures-side, out.width="25%", fig.height=5, message=FALSE, echo=FALSE}
# 
# # m plots ####
# 
#   ggplot(data = df_monthly, aes(x = DATE, y = Unemployed_)) +
...
#   
#   ggplot(data = df_monthly, aes(x = DATE, y = employedpct_over16)) +
#     geom_col(fill="darkorchid") +
#     theme(panel.background = element_rect(fill = "#eeeeee")) +
...
#   
#   ggplot(data = df_monthly, aes(x = DATE, y = notinLFpct_over16)) +
#     geom_col(fill="darkorchid") +
#     theme(panel.background = element_rect(fill = "#eeeeee")) +
...
#     labs(subtitle="Percent of Population Over 16")
#   
#   ggplot(data = df_monthly, aes(x = DATE, y = unemployedpct_over16)) +
#     geom_line(colour = "darkorchid") +
#     theme(panel.background = element_rect(fill = "#eeeeee")) +
