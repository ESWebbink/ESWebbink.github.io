...
=======
                     key = "Population",
>>>>>>> f389cf403bdc9960ca71386ae55757a1b2376cbf
                     value = "Count",
                     -Yr_Mo,
                     na.rm=FALSE)
...
=======
df_emp_cat$Population <- gsub("Total_Nonfarm_Employees", 
                              "Total", 
                              df_emp_cat$Population)

df_emp_cat$Population <- gsub("Private_Employees", 
                              "Private", 
                              df_emp_cat$Population)

df_emp_cat$Population <- gsub("Govt_Employees", 
                              "Government", 
                              df_emp_cat$Population)

df_emp_govt_cat$Population <- gsub("Govt_Employees", 
                              "Government", 
                              df_emp_govt_cat$Population)

df_emp_govt_cat$Population <- gsub("Federal_Employees", 
                              "Federal", 
                              df_emp_govt_cat$Population)

df_emp_govt_cat$Population <- gsub("State_Employees", 
                              "State", 
                              df_emp_govt_cat$Population)

df_emp_govt_cat$Population <- gsub("Local_Employees", 
                              "Local", 
                              df_emp_govt_cat$Population)

# Make 'Population' an ordered factor
df_emp_cat$Population <- ordered(df_emp_cat$Population,
>>>>>>> f389cf403bdc9960ca71386ae55757a1b2376cbf
                                 levels = c("Total",
                                            "Private",
                                            "Government"
...
=======
df_emp_govt_cat$Population <- ordered(df_emp_govt_cat$Population,
>>>>>>> f389cf403bdc9960ca71386ae55757a1b2376cbf
                                 levels = c("Government",
                                            "Federal",
                                            "State",
